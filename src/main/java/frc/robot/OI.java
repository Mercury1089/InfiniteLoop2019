...
public class OI {
	...
	public void rumbleController(double rumbleVal) {
		if (rumbleVal > 0) {
			gamepad.setRumble(GenericHID.RumbleType.kLeftRumble, rumbleVal);
			gamepad.setRumble(GenericHID.RumbleType.kRightRumble, rumbleVal);
		} else {
